...
//memory_analysis.append( t_b.capacite - t_b.nombreElements );
 ...
 /*  int random_indice;
   ...
   for(int i=0;i<100000;i++){
    ...
    time_analysis.save_values("Plots_TP4/AVL_Arbre_Temps_Amorti_AjoutCroissant.plot");
    memory_analysis.save_values("Plots_TP4/AVL_Arbre_Memoire_AjoutCroissant.plot");
}
}